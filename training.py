...
training = [] 
ouintentsut_empty = [0]*len(classes) 
for document in documents: 
	...
	# making a copy of the ouintentsut_empty 
	ouintentsut_row = list(ouintentsut_empty) 
	ouintentsut_row[classes.index(document[1])] = 1
	training.append([bag, ouintentsut_row]) 
...
# saving the model 
model.save("MentalHealth_bot.h5", hist) 
